							...
							<div class="form-group">
								...
								<c:choose>
									<c:when test="${userVo.gender eq 'male' }">
										<!-- 성별이 "남자"일 때 -->
										<label for="rdo-male">남</label> <input type="radio" id="rdo-male" name="gender" value="male" checked>
									...
									<c:when test="${userVo.gender eq 'female' }">
										...
										<label for="rdo-female">여</label> <input type="radio" id="rdo-female" name="gender" value="female" checked>
									</c:when>
									<c:otherwise>
										<label for="rdo-male">남</label> <input type="radio" id="rdo-male" name="gender" value="male">
										<label for="rdo-female">여</label> <input type="radio" id="rdo-female" name="gender" value="female">
